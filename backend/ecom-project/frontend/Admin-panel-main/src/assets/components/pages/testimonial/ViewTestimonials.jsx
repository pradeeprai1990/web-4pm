...
const rows = [
  ['Anjali Sharma', 'Interior Designer', '5', '1', 'Active'],
  ['Rahul Mehta', 'Store Owner', '4.8', '2', 'Inactive'],
  ['Priya Jain', 'Customer', '5', '3', 'Active']
]

export default function ViewTestimonials() {
  return <StaticView title='View Testimonial' section='Testimonial' columns={['Name', 'Role', 'Rating', 'Order']} rows={rows} />
}
